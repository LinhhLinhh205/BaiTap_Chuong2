...
namespace VD16_TraSinhVien
{
    public partial class Form1 : Form
    {
        ...
        private void GanDuLieu()
        {
            ...
            btnTruoc.Enabled = !(lstDs.SelectedIndex == 0);
            btnSau.Enabled = !(lstDs.SelectedIndex == lstDs.Items.Count - 1);
        }
        ...
        {
            if (lstDs.SelectedIndex == 0)
                return;
            lstDs.SelectedIndex = lstDs.SelectedIndex - 1;
            tabHV_SelectedIndexChanged(sender, e);
        }

        private void tabHocVien_Click(object sender, EventArgs e)
        {
            
        }
        private void tabHV_SelectedIndexChanged(object sender,EventArgs e)
        {
            if (tabHV.SelectedIndex == 1)
            {
        ...
        {
            if (lstDs.SelectedIndex == lstDs.Items.Count-1)
                return;
            lstDs.SelectedIndex = lstDs.SelectedIndex + 1;
            tabHV_SelectedIndexChanged(sender, e);
        }
